...
const basicResult = analyze(basic.ast, { task: 'simplify' });
...
const coeffResult = analyze(coeff.ast, { task: 'simplify' });
...
const distResult = analyze(dist.ast, { task: 'simplify' });
...
const complexResult = analyze(complex.ast, { task: 'simplify' });
...
const mixedResult = analyze(mixed.ast, { task: 'simplify' });
