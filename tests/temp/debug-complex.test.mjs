...
const fullResult = analyze(full.ast, { task: 'distribute' });
...
const yResult = analyze(yTerms.ast, { task: 'distribute' });
...
const zResult = analyze(zTerms.ast, { task: 'distribute' });
...
const xResult = analyze(xTerms.ast, { task: 'distribute' });
