...
const nestedResult = analyze(nested.ast, { task: 'simplify' });
...
const polyResult = analyze(polynomial.ast, { task: 'simplify' });
...
const fracResult = analyze(fractions.ast, { task: 'simplify' });
...
const negResult = analyze(negative.ast, { task: 'simplify' });
...
const multiResult = analyze(multiVar.ast, { task: 'simplify' });
...
const zeroResult = analyze(zeros.ast, { task: 'simplify' });
...
const identResult = analyze(identities.ast, { task: 'simplify' });
...
const complexResult = analyze(complexNested.ast, { task: 'simplify' });
...
const powerResult = analyze(powers.ast, { task: 'simplify' });
...
const veryComplexResult = analyze(veryComplex.ast, { task: 'simplify' });
